...
\titlebackground*{assets/gpnubackground}

\newcommand{\hrefcol}[2]{\textcolor{cyan}{\href{#1}{#2}}}

\title{GoicO Mini-batch Learn}
\subtitle{降龙十八掌}
...
\begin{verbatim}
\usepackage{graphicx}
\includegraphics[width=\textwidth]{assets/gpnu-logo}
\end{verbatim}
\end{block}
\end{column}
\begin{column}{0.3\textwidth}
\includegraphics[width=\textwidth]{assets/gpnu-logo.pdf}
\end{column}
\end{columns}
\end{frame}
...
\begin{chapter}[assets/gpnubackground-L]{}{Special Slides}
\begin{itemize}
\item Chapter slides
